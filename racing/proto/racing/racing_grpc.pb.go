...
type RacingClient interface {
	...
	GetSingleRace(ctx context.Context, in *GetSingleRaceRequest, opts ...grpc.CallOption) (*GetSingleRaceResponse, error)
}
...
func (c *racingClient) GetSingleRace(ctx context.Context, in *GetSingleRaceRequest, opts ...grpc.CallOption) (*GetSingleRaceResponse, error) {
	out := new(GetSingleRaceResponse)
...
type RacingServer interface {
	...
	// get single race by its ID
	GetSingleRace(context.Context, *GetSingleRaceRequest) (*GetSingleRaceResponse, error)
}
...
func (UnimplementedRacingServer) GetSingleRace(context.Context, *GetSingleRaceRequest) (*GetSingleRaceResponse, error) {
